...
<html lang="en">
  ...
  <?php include "nav.php"?>
    ...
    <section class="home-slider-loop-false  inner-page owl-carousel">
      <div class="slider-item" style="background-image: url('img/nutrition.jpg');">
        ...
        <div class="row">
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                <h3>one_on_one_coaching</h3>
                <p>personalized nitrition plans tailored to individual health goals and dietary needs.</p>
          ...
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                ...
                <p>collaborative nitrition sessions with a group of people who share sililar health goals.</p>
        ...
        <div class="row">
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                ...
                <p>virtual nutrition coaching for clients who prefer remote consulations.</p>
          ...
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              <div class="bg-image" style="background-image: url('img/img_1_square.jpg');"></div>
              <div class="text">
                <h3>special diet program</h3>
                <p>nutrition plans focused on specific dietary needs, such as gluten-free, vegan, keto, or paleo diets.</p>
          ...
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                ...
                <p>structured nutrition coaching aimed at helping clients achieve their weight loss or weight gain goals.</p>
          ...
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                ...
                <p>nutrition coaching for the entire family to promote Healthyeating habits at home.</p>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-5 mb-5">
            ...
            <ul class="list-unstyled footer-link">
              ...
              <li class="d-block"><span class="d-block">Email:</span><span class="text-white">khushianghan.com</span></li>
            </ul>
          </div>
