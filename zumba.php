        ...
        <div class="row">
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                <h3>energetic dance moves:</h3>
                <p>enjoy high energy dance routines that keep you moving and grooving to the beat.</p>
          ...
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                ...
                <p>burn calories and improve cardiovascular health with fun and engaging workouts.</p>
        ...
        <div class="row">
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                ...
                <p>join a supportive and friendly community, making fitness fun and social.</p>
          ...
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                <h3>stress relief:</h3>
                <p>reduce stress and boots your mood with uplifting music and movement..</p>
          ...
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                ...
                <p>whether you're abeginner or an experienced dancer, zumba classes cater to all fitness levels.</p>
          ...
          <div class="col-md-6 mb-4">
            <div class="blog d-block d-lg-flex">
              ...
              <div class="text">
                ...
                <p>experience zumba in the great outdoors, taking advantage of fresh air and open spaces.</p>
